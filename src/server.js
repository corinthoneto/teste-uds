...
let server = new Server({
  ...
  seeds(server) {
    ...
    /* Tempo de preparo = tempoPreparo / Valor em minutos*/
    server.create("adicional", {id: 1, valor: 3.00, descricao: "Leite Ninho", tempoPreparo: 0, quantidade: 0 })
    server.create("adicional", {id: 2, valor: 0.00, descricao: "Granola", tempoPreparo: 0, quantidade: 0 })
    server.create("adicional", {id: 3, valor: 3.00, descricao: "Paçoca", tempoPreparo: 3, quantidade: 0 })
  },
